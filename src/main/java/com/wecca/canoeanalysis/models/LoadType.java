 ...
 * Note: enum values can't be accessed in @JsonSubTypes.Type so when anything here is changed it must also be changed in the Load YAML model annotation (see Load class)
 */
@Getter
@AllArgsConstructor
public enum LoadType {
    POINT_LOAD("Point Load", 'p'),
    POINT_LOAD_IS_SUPPORT("Point Support", 'p'),
